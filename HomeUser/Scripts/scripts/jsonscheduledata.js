window.blockTime = [{
    Id: 1,
    Subject: "MAINTENANCE",
    StartTime: new Date(2014, 4, 5, 8),
    EndTime: new Date(2014, 4, 5, 10),
    resId: 3,
    BlockAppointment: true
}, {
    Id: 2,
    Subject: "SERVICE",
    StartTime: new Date(2014, 4, 5, 9),
    EndTime: new Date(2014, 4, 5, 11),
    resId: 1,
    BlockAppointment: true
}, {
    Id: 3,
    Subject: "SERVICE",
    StartTime: new Date(2014, 4, 6),
    EndTime: new Date(2014, 4, 6),
    resId: 1,
    BlockAppointment: true,
    FullDay: true
}, {
    Id: 4,
    Subject: "BAD MONSOON",
    StartTime: new Date(2014, 4, 5, 15, 30),
    EndTime: new Date(2014, 4, 5, 17),
    resId: 1,
    BlockAppointment: true
}, {
    Id: 5,
...
window.BlockDayApps = [{
    ...
    StartTime: new Date(2014, 4, 5, 12, 00),
    EndTime: new Date(2014, 4, 5, 14, 30),
    Description: "",
    AllDay: false,
    Recurrence: true,
    ...
    EndTime: new Date(2014, 4, 5, 5, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
    categoryId: 1, roomId: 2, ownerId: 3
    ...
    StartTime: new Date(2014, 4, 5, 11, 30),
    EndTime: new Date(2014, 4, 5, 13),
    Description: "",
    AllDay: false,
    Recurrence: true,
    RecurrenceRule: "FREQ=DAILY;INTERVAL=2;COUNT=10",
    ...
    EndTime: new Date(2014, 4, 5, 13, 30),
    Description: "",
    AllDay: false,
    Recurrence: false,
    categoryId: 1, roomId: 2, ownerId: 5
}, {
    Id: 105,
    Subject: "#SG 345 Renfrewshire - Lancashire",
    StartTime: new Date(2014, 4, 5, 06, 30),
    EndTime: new Date(2014, 4, 5, 07, 30),
    Description: "",
    AllDay: false,
    Recurrence: false,
    categoryId: 1, roomId: 2, ownerId: 3
...
window.QueryCellApps = [
{
    Id:1,
    Subject: "Maintenance",
    StartTime: new Date(2014, 3, 30, 02, 30),
    EndTime: new Date(2014, 3, 30, 04, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
...
},
{
    Id: 3,
    Subject: "Technology Book Stall",
    StartTime: new Date(2014, 4, 15, 12, 30),
    EndTime: new Date(2014, 4, 15, 16, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
    EventType: "Public Event", roomId: 1, ownerId: 1
},
{
    Id: 4,
    Subject: "Technology Book Stall",
    StartTime: new Date(2014, 4, 10, 12, 30),
    EndTime: new Date(2014, 4, 10, 16, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
...
},
{
    ...
    StartTime: new Date(2014, 4, 5, 17, 30),
    EndTime: new Date(2014, 4, 5, 21, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
...
},
{
    Id: 6,
    Subject: "Annual Conference",
    StartTime: new Date(2014, 4, 15, 17, 30),
    EndTime: new Date(2014, 4, 15, 21, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
    EventType: "Commercial Event", roomId: 1, ownerId: 1
    ...
    Id: 7,
    Subject: "Annual Conference",
    StartTime: new Date(2014, 4, 10, 17, 30),
    EndTime: new Date(2014, 4, 10, 21, 00),
    Description: "",
    AllDay: false,
    Recurrence: false,
    ...
    Subject: "IMI Meeting",
    StartTime: new Date(2014, 4, 5, 15, 30),
    EndTime: new Date(2014, 4, 5, 18, 30),
    ...
    EndTime: new Date(2014, 4, 5, 19, 00),
    ...
    StartTime: new Date(2014, 4, 2, 17, 00),
